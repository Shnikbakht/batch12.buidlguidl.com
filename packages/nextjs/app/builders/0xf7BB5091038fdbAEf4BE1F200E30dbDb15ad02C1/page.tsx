    ...
    <div className="p-8 font-sans flex items-center justify-center min-h-screen">
      <div className="max-w-xl w-full rounded-lg p-8">
        ...
        <div className="text-center">
          ...
          />
          <h1 className="text-xl font-sans dark:text-white font-bold mt-4">{ProfileInfo.name}</h1>
          <div className="flex justify-center mt-2">
            <Address address={ProfileInfo.address} />
          </div>
          <p className="text-lg font-sans text-gray-500">{ProfileInfo.role}</p>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="flex space-x-6 justify-center">
            ...
            <a
              href={ProfileInfo.links.twitter}
              target="_blank"
              rel="noopener noreferrer"
